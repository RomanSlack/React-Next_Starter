...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-pink-50 to-orange-50">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            Welcome to <span className="text-neutral-600">Skema</span>
          </h1>
          ...
          <div className="flex gap-4 justify-center">
            <Link
              href="/auth/login"
              className="bg-neutral-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-neutral-700 transition-colors"
            >
              Get Started
            </Link>
            <Link
              href="/auth/register"
              className="bg-white text-neutral-600 px-8 py-3 rounded-lg font-semibold border-2 border-neutral-600 hover:bg-neutral-50 transition-colors"
            >
              Sign Up
            </Link>
          </div>
